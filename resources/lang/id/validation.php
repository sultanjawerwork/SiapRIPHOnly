...
return [
	...
	'attributes'                     => [],
	'customAttributes' => [
		'userDoc'		=> 'Berkas-berkas kelengkapan',
		'sptjm'			=> 'Surat Pertanggungjawaban Mutlak (SPTJM)',
		'formLa'		=> 'Laporan Akhir (Form-LA)',
		'rta'			=> 'Form Realisasi Tanam (Form-RTA)',
		'spvp'			=> 'Surat Pengajuan Verifikasi Produksi',
		'rpo'			=> 'Form Realisasi Produksi (Form-RPO)',
		'sphproduksi'	=> 'SPH-SBS (Produksi)',
		'statusProd'	=> 'Status Verifikasi Produksi',
		'realisasiProduksi'	=> 'Realisasi Produksi',
		'verifTanam'	=> 'Verifikasi tahap Tanam',
		'verifProduksi'	=> 'Verifikasi tahap Produksi',
	],
	'customMessages' => [
		'statusProd' => [
			'in' => ':attribute Anda tidak memenuhi syarat.',
		],
		'realisasiProduksi' => [
			'min'       => [
				'numeric' => 'Jumlah :attribute yang dilaporkan kurang dari :min.',
			],
		],
		'tahapVerifikasi' => [
