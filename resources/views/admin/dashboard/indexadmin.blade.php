...
<div class="panel" id="panel-title-1">
	<div class="panel-hdr">
		...
		<div class="panel-toolbar">
			<a class="mr-1 btn btn-success btn-xs btn-icon waves-effect waves-themed" data-toggle="collapse" href="#panelA" role="button" aria-expanded="false" aria-controls="panelA">
				<i class="fal fa-minus"></i>
			</a>
		</div>
	</div>
</div>
<div class="collapse show mb-3" id="panelA">
	<div class="row">
		<div class="col-md-3">
...
<div class="panel" id="panel-title-2">
	<div class="panel-hdr">
		...
		<div class="panel-toolbar">
			<a class="mr-1 btn btn-success btn-xs btn-icon waves-effect waves-themed" data-toggle="collapse" href="#panelB" role="button" aria-expanded="false" aria-controls="panelB">
				<i class="fal fa-minus"></i>
			</a>
		</div>
	</div>
