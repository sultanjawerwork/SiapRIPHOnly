...
@endif --}}
    <form method="POST" action="{{ route("admin.riphAdmin.update", [$riphAdmin->id]) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="panel" id="panel-1">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <div class="row d-flex">
                                <div class="col-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control " name="periode" placeholder="Periode" value="{{ $riphAdmin->periode }}" required>
                                        </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="updated_at" placeholder="dd-mm-yyyy" value="{{ date('Y-m-d h:i:s') }}" readonly>
                                        </div>
                                        <div class="help-block">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="v_pengajuan_import" class="form-control" placeholder="total volume" value="{{ $riphAdmin->v_pengajuan_import }}" required>
                                        </div>
                                        <div class="help-block">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="v_beban_tanam" placeholder="" value="{{ $riphAdmin->v_beban_tanam }}">
                                        </div>
                                        <div class="help-block">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="v_beban_produksi"   placeholder="" value="{{ $riphAdmin->v_beban_produksi }}">
                                        </div>
                                        <div class="help-block">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label class="form-label" for="jumriph">Jumlah Importir</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="inputGroupPrepend3"><i class="fal fa-ruler"></i></span>
                                            </div>
                                            <input type="number" id="jumriph" name="jumlah_importir" class="form-control" value="{{ $riphAdmin->jumlah_importir }}" required>
                                        </div>
                                        <div class="help-block">
                                            Jumlah Importir terdaftar pada periode ini.
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        <div class="col-md-4 ml-auto text-right">
                            <a href="{{route('admin.riphAdmin.index')}}" class="btn btn-warning btn-sm mt-3">Cancel</a>
