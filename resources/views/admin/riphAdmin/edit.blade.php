	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel" id="panel-1">
				...
				<form action="{{route('admin.riphAdmin.update', $riphAdmin->id)}}" method="post">
					@csrf
                    @method('put')
								...
								<div class="col-4 mb-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control " name="periode" id="periode" placeholder="tahun RIPH" value="{{ old('periode', $riphAdmin->periode) }}" required>
										</div>
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="number" class="form-control " id="jumlah_importir" name="jumlah_importir" value="{{ old('jumlah_importir', $riphAdmin->jumlah_importir) }}" required>
										</div>
										<div class="help-block">
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input name="v_pengajuan_import" id="v_pengajuan_import" type="number" class="form-control" placeholder="total volume" value="{{ old('v_pengajuan_import', $riphAdmin->v_pengajuan_import) }}" required>
										</div>
										<div class="help-block">
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input name="v_beban_tanam" id="v_beban_tanam" value="{{ old('v_beban_tanam', $riphAdmin->v_beban_tanam) }}" class="form-control" value="" readonly>
										</div>
										<div class="help-block">
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input name="v_beban_produksi" id="v_beban_produksi" type="text" class="form-control" placeholder="autocalculate" value="{{ old('v_beban_produksi', $riphAdmin->v_beban_produksi) }}" readonly>
