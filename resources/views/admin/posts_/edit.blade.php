    ...
    <div class="col-md-12">   
        <form method="post" action="{{ route('admin.posts.update', [$post->id]) }}">
            ...
            <div id="panel-1" class="panel">
                <div class="panel-hdr">
                    <h2>
                        Artikel/berita | <span class="fw-300"><i>Ubah</i></span>
                    </h2>
                                    ...
                                    <span class="mr-auto">
                                        <div class="form-group">
                                            <div class="custom-control custom-switch" data-toggle="tooltip" title
                                                ...
                                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ !empty($post->published_at)  ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-sm input-group-multi-transition">
                                        <input type="text" class="form-control form-control-sm" aria-label="" name="tags" id="tags"
                                            placeholder="tambahkan tag.." value="{{ old('tags', $post->tags) }}">
                                    </div>
