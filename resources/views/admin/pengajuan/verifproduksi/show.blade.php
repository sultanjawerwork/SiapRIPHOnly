											...
											<tr>
												...
												<td>
													@if ($userDocs->sphproduksicheck)
														<span>{{$userDocs->sphproduksicheck}}</span>
													@else
														<span class="text-danger text-center">Tidak ada data</span>
													@endif
												</td>
											...
											<tr>
												...
												<td>
													@if ($userDocs->logbookproduksicheck)
														<span>{{$userDocs->logbookproduksicheck}}</span>
													@else
														<span class="text-danger text-center">Tidak ada data</span>
													@endif
												</td>
											...
											<tr>
												...
												<td>
													@if ($userDocs->formLacheck)
														<span>{{$userDocs->formLacheck}}</span>
													@else
														<span class="text-danger text-center">Tidak ada data</span>
													@endif
												</td>
