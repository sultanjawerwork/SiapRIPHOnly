							...
							<form action="{{$actionRoute}}" method="POST" enctype="multipart/form-data">
								...
								<div class="panel-container show">
									<div class="panel-content">
										...
										<div class="form-group">
											...
											<textarea name="note" id="note" class="form-control form-control-sm" rows="3" readonly>{{$pks->note}}</textarea>
											<small id="helpId" class="text-muted">Catatan penting hasil pemeriksaan</small>
										</div>
										<div class="form-group">
											<label for="status">Status Pemeriksaan</label>
											<input type="text" class="form-control form-control-sm" name="status" id="status" value="{{$pks->status}}" readonly>
								...
								<div class="card-footer row d-flex justify-content-between">
									...
									<div class="col-md-6 text-right">
										<a class="btn btn-sm btn-primary" href="{{$cancelRoute}}" role="button"><i class="fal fa-undo text-align-center mr-1"></i> Kembali</a>
