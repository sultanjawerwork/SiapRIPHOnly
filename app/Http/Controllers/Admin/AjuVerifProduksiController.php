...
class AjuVerifProduksiController extends Controller
{
	...
	public function create($id)
	{
		...
		return view('admin.pengajuan.verifproduksi.create', compact('module_name', 'page_title', 'page_heading', 'heading_class', 'commitment', 'total_luastanam', 'total_volume', 'pks', 'disabled', 'countPoktan', 'countPks'));
	}
	...
	public function store(Request $request, $id)
	{
		...
		$pengajuan->npwp = $commitment->npwp;
